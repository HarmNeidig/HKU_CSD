#!/bin/bash
input_dir=~/desktop/HKU_CSD/CSD2d/BASH_MultiFileProgram/audio_resources/raw_input/
output_dir=~/desktop/HKU_CSD/CSD2d/BASH_MultiFileProgram/audio_resources/converted_input/
