 ...
 * private field?
 *   - It creates a read only privelige for that public function.
 *     If the variable were public, any method could change the value.
 *
 ...
 *    - You cannot access the sound variable from the main file.
 *      You can however see the value through the getSound method.
 */
